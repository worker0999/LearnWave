      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-cyan-200">Stay updated with the latest notices and circulars</p>
          </div>
          ...
          {loading ? (
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              <CardContent className="p-12 text-center">
                <AlertCircle className="w-12 h-12 text-cyan-300 mx-auto mb-4" />
                <h3 className="text-white text-lg font-semibold mb-2">No announcements found</h3>
                <p className="text-cyan-200">Try adjusting your filters or search terms</p>
              </CardContent>
            </Card>
          ) : (
            filteredAnnouncements.map((announcement) => (
              <Card
                ...
                className={`bg-white/10 backdrop-blur-md border-white/20 transition-all hover:bg-white/20 ${
                  !announcement.read ? 'border-l-4 border-l-cyan-400' : ''
                }`}
              >
                <CardContent className="p-6">
                  ...
                  {announcement.attachments && announcement.attachments.length > 0 && (
                    <div className="mb-4">
                      <p className="text-cyan-300 text-sm mb-2">Attachments:</p>
