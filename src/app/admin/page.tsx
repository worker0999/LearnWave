      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-purple-200">Manage LearnWave platform</p>
          </div>
        ...
        {analytics && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/20 transition-all transform hover:scale-105">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-purple-200">Active Students</CardTitle>
                <BookOpen className="h-4 w-4 text-purple-300" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold text-white">{analytics.overview.totalStudents.toLocaleString()}</div>
                <p className="text-xs text-purple-300">Registered students</p>
              </CardContent>
            </Card>

            <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/20 transition-all transform hover:scale-105">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-purple-200">Expert Mentors</CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-purple-300">{analytics.overview.pendingMentors} pending approval</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/20 transition-all transform hover:scale-105">
              ...
              <CardContent>
                ...
                <p className="text-xs text-purple-300">From {analytics.sessions.completedSessions} sessions</p>
              </CardContent>
            </Card>
          </div>
        )}
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-white/10 border-white/20">
            <TabsTrigger value="mentors" className="text-white data-[state=active]:bg-purple-500">
            ...
            <TabsTrigger value="announcements" className="text-white data-[state=active]:bg-purple-500">
              ...
              <CardContent>
                {pendingMentors.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-purple-200">No pending mentor approvals</p>
                  </div>
                ) : (
                  <Table>
                    <TableHeader>
                    ...
                    <TableBody>
                      {pendingMentors.map((mentor) => (
                        <TableRow key={mentor.id} className="border-white/10">
                          ...
                          <TableCell className="text-purple-200">{mentor.email}</TableCell>
          ...
          <TabsContent value="users">
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              ...
              <CardContent>
                {usersLoading ? (
                  <div className="text-center py-8">
                    <RefreshCw className="w-8 h-8 text-purple-300 mx-auto mb-4 animate-spin" />
                          ...
                          <TableCell>
                            <Badge 
                              className={
                                ...
                                announcement.type === 'COLLEGE_EVENT' ? 'bg-green-500' : 'bg-purple-500'
                              }
                            >
                          ...
                          <div key={mentor.id} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-purple-300 text-xs">{mentor.expertise.slice(0, 2).join(', ')}</p>
                              </div>
                            </div>
                          ...
                          <div key={session.id} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-purple-300 text-xs">₹{session.amount} • {session.status}</p>
                              </div>
                            </div>
                            <div className="text-right">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                        <div>
                          ...
                          <p className="text-purple-300 text-sm">Temporarily disable platform access</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                        <div>
                          ...
                          <p className="text-purple-300 text-sm">Manage system email settings</p>
                        </div>
                        <Button variant="outline" className="border-purple-400 text-purple-200">
                          Configure
                        </Button>
                      ...
                      <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                        <div>
                          ...
                          <p className="text-purple-300 text-sm">Configure payment gateway</p>
                        </div>
                        <Button variant="outline" className="border-purple-400 text-purple-200">
                          Configure
                        </Button>
