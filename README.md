...
If you're developing on Windows (cmd.exe or PowerShell), the Unix `tee` piping used in older scripts may cause issues. Use these commands instead.
...
If you prefer a hot-reloading dev workflow on Windows, run:
